...
def format_answer(text):
    """
    Used to format the correct_answer and player_answer
    removing characters, spaces and leading article
    words to check if the player_answer is correct.
    E.g. If the correct answer to a question is "X-Men"
    then player submissions of XMen, xmen, x-men,
    The X-Men etc should all return as a correct answer
    """
